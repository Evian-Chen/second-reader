...
8. [Advanced Patterns](#8-advanced-patterns) — **LOW**
   ...
   - 8.4 [Follow Redux Official Style Guide](#84-follow-redux-official-style-guide)
...
### 8.4 Follow Redux Official Style Guide

**Impact: MEDIUM (avoids mutation/side-effect bugs, enables DevTools and maintainability)**
...
8. [https://redux.js.org/style-guide](https://redux.js.org/style-guide)
9. [https://redux-toolkit.js.org/rtk-query/overview](https://redux-toolkit.js.org/rtk-query/overview)
